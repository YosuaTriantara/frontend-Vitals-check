    ...
    >
      ...
      <div className="flex flex-col gap-2">
        ...
        <p className="text-[18px] font-normal leading-[29.25px] text-white opacity-95">
          Risiko kesehatan {riskLabel} terdeteksi berdasarkan {observations.join(', ')}.
          Gunakan rekomendasi di bawah sebagai langkah lanjut untuk menjaga kondisi Anda.
        </p>
...
export default function ResultsPage({
  ...
  const trendScores = sortedScores.map((item) => healthScoreFromRisk(item.riskScore));
